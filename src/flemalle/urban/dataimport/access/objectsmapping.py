...
from flemalle.urban.dataimport.access.mappers import LicenceFactory, IdMapper, PortalTypeMapper, WorklocationMapper, \
    ...
    DecisionEventDateMapper, DecisionEventNotificationDateMapper, SubjectMapper, ContactMapper
...
#
            WorklocationMapper: {
                'from': ('Ruer', 'Nur', 'Comr', 'Cpr', 'LibelleRue', 'Nuo', 'Commune', 'CodePostal'),
                'to': 'workLocations',
            },
#
#             # WorkTypeMapper: {
...
#
    ...
    'CONTACT':
    {
        ...
        'mappers': {
            ContactMapper: {
                'from': ('Cpr', 'Comr', 'Ruer', 'Nur', 'CodePostal', 'Commune', 'Nom', 'Prenom' 'LibelleRue', 'Nuo'),
